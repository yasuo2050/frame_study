...
type HelloRequest struct {
	...
	Name          string                 `protobuf:"bytes,1,opt,name=name,proto3" json:"name,omitempty"` // 包含一个叫 name 的字符串字段
...
type HelloReply struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Message       string                 `protobuf:"bytes,1,opt,name=message,proto3" json:"message,omitempty"` // 包含一个叫 message 的字符串字段
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_greeter_proto_rawDesc = "" +
	"\n" +
	"\rgreeter.proto\x12\x05proto\x1a\x1cgoogle/api/annotations.proto\"\"\n" +
	...
	"\aGreeter\x12K\n" +
	"\bSayHello\x12\x13.proto.HelloRequest\x1a\x11.proto.HelloReply\"\x17\x82\xd3\xe4\x93\x02\x11:\x01*\"\f/v1/sayhelloB\tZ\a./protob\x06proto3"
